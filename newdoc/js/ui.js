...
export async function shell(title, active) {
  ...
  if (!user) return null;
  const items = [['dashboard.html','ภาพรวม','dashboard'],['create-document.html','สร้างบันทึกข้อความ','document'],['documents.html','เอกสารของฉัน','documents'],['signature.html','ลายเซ็นของฉัน','signature'],['profile.html','ข้อมูลส่วนตัว','profile']];
