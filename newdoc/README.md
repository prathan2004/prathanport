...
2. เปิด SQL Editor แล้วรัน `sql/schema.sql` ตามด้วย `sql/rls.sql` (ไฟล์หลังสร้าง private Storage buckets และ policies ด้วย)
   หากเคยสร้างตารางก่อนเพิ่มตัวปรับลายเซ็น ให้รัน `sql/20260922_signature_layout.sql` เพิ่มหนึ่งครั้ง
...
- ในหน้าแก้เอกสาร ปรับความกว้างลายเซ็น 30-80 มม. ตำแหน่งซ้าย/กลาง/ขวา และระยะห่างจากเนื้อหา 0-30 มม. ได้ ค่าจะบันทึกกับเอกสารและใช้กับพรีวิว PDF และ Word
